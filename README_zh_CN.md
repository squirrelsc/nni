    ...
    <b>内置</b>
      ...
      <ul>
        ...
        <li><b>基于 Kubernetes 的平台</b></li>
            ...
            <ul><li><a href="docs/zh_CN/TrainingService/DLTSMode.md">DLWorkspace (aka. DLTS)</a></li>
      </ul>
      </td>
    </tr>
      <tr align="center" valign="bottom">
...
NNI supports and is tested on Ubuntu >= 16.04, macOS >= 10.14.1, and Windows 10 >= 1809. 在 `python 64-bit >= 3.5` 的环境中，只需要运行 `pip install` 即可完成安装。
