<p align="center">
<img src="img/nni_logo.png" alt="logo" width="300"/>
</p>
...
参考[安装 NNI](Installation.md) 了解系统需求。
...
* 在浏览器中打开 `Web UI url`，可看到下图的实验详细信息，以及所有的尝试任务。 查看[这里的](WebUI.md)更多页面示例。
...
* [如何定义搜索空间](SearchSpaceSpec.md)
* [如何定义一次尝试](howto_1_WriteTrial.md)
* [配置实验](ExperimentConfig.md)
* [如何使用标记](howto_1_WriteTrial.md#nni-python-annotation)

## **教程**

* [在本机运行实验 (支持多 GPU 卡)](tutorial_1_CR_exp_local_api.md)
* [在多机上运行实验](tutorial_2_RemoteMachineMode.md)
* [在 OpenPAI 上运行实验](PAIMode.md)
* [在 Kubeflow 上运行实验。](KubeflowMode.md)
* [使用不同的调参器和评估器](tutorial_3_tryTunersAndAssessors.md)
* [实现自定义调参器](howto_2_CustomizedTuner.md)
...
如要安装 NNI 开发环境，参考： [配置 NNI 开发环境](SetupNNIDeveloperEnvironment.md)。

在写代码之前，请查看并熟悉 NNI 代码贡献指南：[贡献](CONTRIBUTING.md)。

我们正在编写 [如何调试](HowToDebug.md) 的页面，欢迎提交建议和问题。
